...
class App extends Component {
  ...
  //moves the cards around randomly. 
  ...
  handleClick = (name) => {
    if (!this.state.gameover) {
      if (this.state.selected.indexOf(name) === -1) {
        ...
        console.log("Oops!!  Game-Over You made the puppy sad!");
        this.reset();
        setTimeout(() => {
